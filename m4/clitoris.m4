dnl clitoris.m4 --- checks necessary for the clitoris test harness
dnl
...
dnl
dnl This file is part of clitoris.

AC_DEFUN([AX_CHECK_CLITORIS], [dnl
...
])dnl AX_CHECK_CLITORIS

dnl clitoris.m4 ends here
